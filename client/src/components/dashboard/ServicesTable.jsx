                ...
                <tr key={service?.id}>
                  <td className="px-8 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                    <div className="inline-flex items-center gap-x-3">
                      <h2 className="text-base font-normal text-gray-900">{service?.service_name}</h2>
                    </div>
                  </td>
                  <td className="px-4 py-4 text-base text-gray-500 dark:text-gray-300 whitespace-nowrap">{service?.category_name}</td>
                  <td className="px-12 py-4 text-base text-gray-500 dark:text-gray-300 whitespace-nowrap">{service?.subcategory_name}</td>
                  <td className="px-12 py-4 text-base text-gray-500 dark:text-gray-300 whitespace-nowrap">{service?.first_name} {service?.last_name}</td>
                  <td className="px-12 py-4 text-base text-gray-500 dark:text-gray-300 whitespace-nowrap">{service?.price}</td>
                  <td className="px-4 py-4 text-base text-gray-500 dark:text-gray-300 whitespace-nowrap">{service?.created_at}</td>
