...
function UserLogin() {
  ...
  const login = (e) => {
    ...
    axios.post('http://localhost:8000/v1/users/login' , { email , password })
    .then(response => {
...
<div className="h-screen flex">
  <div className="flex w-1/2 bg-gradient-to-tr from-secondary to-primary i justify-around items-center">
    <div>
      <h1 className="text-white font-bold text-4xl font-sans">LOGO</h1>
    </div>
  </div>
